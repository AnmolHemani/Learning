...
def scrape_data(url, retries=3, delay=5):
    ...
    for attempt in range(1, retries + 1):
        ...
        try:
            response = app.scrape_url(url)  # ✅ No 'params' here
...
def format_data(data, fields=None, max_length=3000):
    ...
    llm = ChatGroq(
        ...
        model_name="llama3-8b-8192",  # ✅ Updated to current working model
        temperature=0.3
    )
    ...
    if fields is None:
        fields = [
            ...
            "Open House Date & Time", "Agent Name", "Agent Contact",
            "Property Type", "Listing URL", "Image URL"
        ]
...
if __name__ == "__main__":
    url = "https://www.realtor.com/realestateandhomes-search/Scottsdale_AZ/show-open-house/sby-5"
